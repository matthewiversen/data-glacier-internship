...
class _CustomSingleNotificationBehavior(AbstractSingleNotificationBehavior):
    ...
    def do_wait_suspend(self, thread_info, stop_reason):
        with self.notify_thread_suspended(
            thread_info.thread_id, thread_info.thread, stop_reason=stop_reason
        ):
...
def test_single_notification_3(
    single_notification_behavior, notification_queue, _dummy_pydb
):
    """
    3. Deadlocked thread
...
def test_single_notification_4(
    single_notification_behavior, notification_queue, _dummy_pydb
):
    """
    4. Delayed stop
