...
pytestmark = pytest.mark.skipif(
    sys.version_info[0] < 3 or TODO_PY311,
    reason="Only available for Python 3. / Requires bytecode support in Python 3.11",
)
...
def check_name_and_line(found, expected):
    ...
    if names_and_lines != set(expected):
        raise AssertionError(
            "Found: %s"
            % (sorted(names_and_lines, key=lambda tup: tuple(reversed(tup))),)
        )
...
def test_smart_step_into_bytecode_info_002():
    ...
    check_name_and_line(
        found, [("_getframe", 1), ("bar", 2), ("Something", 3), ("call", 5)]
    )
...
def test_smart_step_into_bytecode_info_003():
    def function():
        yield sys._getframe()
        bbb = foo.bar(Something(param1, param2=xxx.yyy), {})
        call()
...
def test_smart_step_into_bytecode_info_004():
    def function():
        yield sys._getframe()
        bbb = foo.bar(Something(param1, param2=xxx.yyy), {1: 1})  # BUILD_MAP
        call()
...
def test_smart_step_into_bytecode_info_006():
    def function():
        yield sys._getframe()
        foo.bar(Something(), {1: 1, 2: [x for x in call()]})
        call2()
...
def test_smart_step_into_bytecode_info_009():
    ...
    check_name_and_line(
        found, [("_getframe", 1), ("__getitem__", 2), ("__getitem__().__call__", 2)]
    )
...
def test_smart_step_into_bytecode_info_013():
    ...
    check_name_and_line(
        found, [("_getframe", 1), ("__getitem__().__call__", 2), ("__getitem__", 2)]
    )
...
def test_smart_step_into_bytecode_info_014():
    ...
    check_name_and_line(
        found, [("_getframe", 1), ("RuntimeError", 3), ("call2", 5), ("call3", 7)]
    )
...
@pytest.mark.skipif(
    ...
    reason="Walrus operator only available for Python 3.8 onwards.",
)
...
def test_smart_step_into_bytecode_info_027():
    ...
    check_name_and_line(
        found, [("_getframe", 1), ("__getitem__", 8), ("__getitem__().__call__", 8)]
    )
...
def test_smart_step_into_bytecode_info_029():
    ...
    check_name_and_line(
        found,
        [("_getframe", 1), ("__add__", 3), ("__mul__", 3), ("__sub__", 3), ("call", 3)],
    )
...
@pytest.mark.skipif(
    ...
    reason="Async only available for Python 3.6 onwards.",
)
...
def test_get_smart_step_into_variant_from_frame_offset():
    ...
    assert (
        pydevd_bytecode_utils.get_smart_step_into_variant_from_frame_offset(19, found)
        is None
    )
    assert (
...
def test_smart_step_into_bytecode_info_00eq():
    ...
    if sys.version_info[:2] < (3, 9):
        check(
            ...
            [
                Variant(
                    name="__eq__", is_visited=True, line=3, offset=18, call_order=1
                ),
                Variant(
                    name="__ne__", is_visited=True, line=5, offset=33, call_order=1
                ),
                Variant(
                    name="__gt__", is_visited=True, line=7, offset=48, call_order=1
                ),
                Variant(
                    name="__ge__", is_visited=True, line=9, offset=63, call_order=1
                ),
                Variant(
                    name="__lt__", is_visited=True, line=11, offset=78, call_order=1
                ),
                Variant(
                    name="__le__", is_visited=True, line=13, offset=93, call_order=1
                ),
