...
class Test(unittest.TestCase):
    ...
    def interpreter(self):
        ...
        try:
            ...
            interpreter = pydevconsole.InterpreterInterface(
                pydev_localhost.get_localhost(), client_port, threading.current_thread()
            )
            yield interpreter
        except:
    ...
    @pytest.mark.skipif(
        not CAN_EVALUATE_TOP_LEVEL_ASYNC, reason="Requires top-level async."
    )
    ...
    def test_console_requests(self):
        with self.interpreter() as interpreter:
            ...
            self.assertTrue(
                ...
                or desc.find("The most base type")
                >= 0,  # Jython 2.7 is providing this :P
    ...
    def test_server(self):
        ...
        try:
            ...
            server = xmlrpclib.Server(
                "http://%s:%s" % (pydev_localhost.get_localhost(), server_port)
            )
