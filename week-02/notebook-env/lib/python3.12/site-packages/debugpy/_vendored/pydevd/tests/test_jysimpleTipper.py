...
class TestSearch(unittest.TestCase):
    def test_search_on_jython(self):
        assert _pydev_jy_imports_tipper.search_definition("os")[0][0].split(os.sep)[
            -1
        ] in ("javaos.py", "os.py")
        self.assertEqual(0, _pydev_jy_imports_tipper.search_definition("os")[0][1])

        assert _pydev_jy_imports_tipper.search_definition("os.makedirs")[0][0].split(
            os.sep
        )[-1] in ("javaos.py", "os.py")
        self.assertNotEqual(
            0, _pydev_jy_imports_tipper.search_definition("os.makedirs")[0][1]
        )
