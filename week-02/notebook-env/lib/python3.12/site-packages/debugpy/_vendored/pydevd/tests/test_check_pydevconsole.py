...
# =======================================================================================================================
@pytest.mark.skipif(
    os.environ.get("TRAVIS") == "true" or not has_ipython,
    reason="Too flaky on Travis (and requires IPython).",
)
        ...
        class ServerThread(threading.Thread):
            ...
            def run(self):
                ...
                pydevconsole.start_server(
                    pydev_localhost.get_localhost(), self.server_port, self.client_port
                )
