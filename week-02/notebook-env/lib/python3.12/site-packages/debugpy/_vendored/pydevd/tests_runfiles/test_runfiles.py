...
class RunfilesTest(unittest.TestCase):
    ...
    def setUp(self):
        self.file_dir = [
            os.path.abspath(
                os.path.join(desired_runfiles_path, "tests_runfiles/samples")
            )
        ]
    ...
    def test___unixify(self):
        ...
        self.assertEqual(
            "c:/temp/junk/asdf.py",
            unixify("c:SEPtempSEPjunkSEPasdf.py".replace("SEP", os.sep)),
        )
    ...
    def test_finding_test_with_unique_name_returns_1_test(self):
        self._setup_scenario(
            self.file_dir, include_tests=["test_i_am_a_unique_test_name"]
        )
    ...
    def test_matching_tests(self):
        ...
        self._setup_scenario(
            self.file_dir,
            None,
            ["StillYetAnotherSampleTest", "SampleTest.test_xxxxxx1"],
        )
        filtered_tests = self.MyTestRunner.filter_tests(self.all_tests)
